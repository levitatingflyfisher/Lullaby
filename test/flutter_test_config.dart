...
/// Flutter renders by default. Fonts are resolved from the active Flutter
/// SDK's font cache (no fonts are vendored into the repo); if they can't be
/// found, tests still run — text simply falls back to boxes.
...
Directory? _materialFontsDir() {
  ...
  // The test runs on the Flutter-bundled Dart at:
